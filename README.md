...
- **Production:** [https://ceptly.ai](https://ceptly.ai) (AWS Amplify)
- **Marketing site:** [https://ceptly.com](https://ceptly.com) (`ceptly-public` repo)
...
| `NEXT_PUBLIC_SITE_URL`           | `https://ceptly.ai`                    |
| `NEXT_PUBLIC_STATSIG_CLIENT_KEY` | Statsig client key                     |
| `NEXT_PUBLIC_BILLING_ENFORCED`   | `true`                                 |

Ensure backend `FRONTEND_URL` is `https://ceptly.ai` for CORS, OAuth redirects, and invite links.
